...
public class TrimMaterialsRegistry {
    ...
    private static void registerAxeBlockTransformer() {
        Mixson.registerEvent(
                ...
                Lifetime.PERSISTENT,
                ErrorPolicy.LOG,
                FixedMinecraft.id("add_axe_block_transformers").toString(),
                ...
                context -> {
                    ...
                    for (JsonElement element : root) {
                        if (element.toString().contains("copper") && !element.toString().contains("waxed")) {
                            element.getAsJsonObject().addProperty("loot", "fixedminecraft:gameplay/other/scrape");
                    ...
                    if (!root.toString().contains("azalea")) {
                        ...
                        rules.add(makeRule("fixedminecraft:azalea_wood", "fixedminecraft:stripped_azalea_wood"));
                        rules.add(makeRule("fixedminecraft:azalea_log", "fixedminecraft:stripped_azalea_log"));
