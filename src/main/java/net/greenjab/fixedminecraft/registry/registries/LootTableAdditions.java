        ...
        LootTableEvents.MODIFY.register((key, tableBuilder, _, holder) -> {
            ...
            if (key==BuiltInLootTables.SIMPLE_DUNGEON) {
                ...
                tableBuilder.pool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.DESERT_VILLAGE_MAP)
                        ...
                        .add(LootItem.lootTableItem(Items.PLAINS_VILLAGE_MAP)
                        ...
                        .add(LootItem.lootTableItem(Items.SAVANNA_VILLAGE_MAP)
                        ...
                        .add(LootItem.lootTableItem(Items.SNOWY_VILLAGE_MAP)
                        ...
                        .add(LootItem.lootTableItem(Items.TAIGA_VILLAGE_MAP)
