...
public class DispencerMinecartEntity extends StorageMinecartEntity {
    ...
    @Override
    public void onActivatorRail(int x, int y, int z, boolean bl) {
    ...
    protected void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.putShort("Cooldown", (short)this.cooldown);
    ...
    protected void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        this.cooldown = nbt.getShort("Cooldown", (short)0);
        setFlipped(nbt.getBoolean("FLipped", false));
    }
