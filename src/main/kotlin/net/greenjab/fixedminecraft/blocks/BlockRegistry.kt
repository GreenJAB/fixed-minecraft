...
object BlockRegistry {
    ...
    val CHIPPED_NETHERITE_ANVIL = NetheriteAnvilBlock(blockSettings(Blocks.NETHERITE_BLOCK) {
        strength(15.0F, 1200.0F)
        sounds(BlockSoundGroup.ANVIL)
        pistonBehavior(PistonBehavior.BLOCK)
    ...
    val DAMAGED_NETHERITE_ANVIL = NetheriteAnvilBlock(blockSettings(Blocks.NETHERITE_BLOCK) {
        strength(15.0F, 1200.0F)
        sounds(BlockSoundGroup.ANVIL)
        pistonBehavior(PistonBehavior.BLOCK)
    ...
    // val COPPER_RAIL =
    //     OxidizableRail(OxidationLevel.UNAFFECTED, Settings.copy(Blocks.POWERED_RAIL)).register("copper_rail")
    // val EXPOSED_COPPER_RAIL =
    //     OxidizableRail(OxidationLevel.EXPOSED, Settings.copy(Blocks.POWERED_RAIL)).register("exposed_copper_rail")
    // val WEATHERED_COPPER_RAIL =
    //     OxidizableRail(OxidationLevel.WEATHERED, Settings.copy(Blocks.POWERED_RAIL)).register("weathered_copper_rail")
    // val OXIDIZED_COPPER_RAIL =
    //     OxidizableRail(OxidationLevel.OXIDIZED, Settings.copy(Blocks.POWERED_RAIL)).register("oxidized_copper_rail")
    //
